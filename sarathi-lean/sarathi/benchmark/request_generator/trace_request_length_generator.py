...
class TraceRequestLengthGenerator(BaseRequestLengthGenerator):
    ...
    def __init__(self, *args, **kwargs):
        ...
        diff_tokens = (
            total_tokens - self._config.trace_request_length_generator_max_tokens
        )
        ...
        assert all(
            self._trace_df["num_prefill_tokens"] + self._trace_df["num_decode_tokens"]
            <= self._config.trace_request_length_generator_max_tokens
        )
        ...
        self._trace_df = self._trace_df[self._trace_df["num_prefill_tokens"] > self._config.trace_request_length_generator_min_tokens]
